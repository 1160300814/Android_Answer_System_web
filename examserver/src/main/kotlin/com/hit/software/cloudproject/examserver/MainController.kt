...
//                rs.getString("user_password")
        ...
        return if (hasResult) {
            "{\"code\":\"101\",\"result\":\"enroll failure\"}"
        } else {
            println(login.user_name+login.user_password)
            mJdbcTemplate!!.update("insert into user_info(user_name, user_password) values(?, ?)", login.user_name, login.user_password)
